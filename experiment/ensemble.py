...
if __name__ == '__main__':
    ...
    '''
    check_point_paths=[]
    check_point_paths.append("~/work/code/udacity-gym/new_data/dave2-v2.ckpt")
    check_point_paths.append("~/work/code/udacity-gym/new_data/dave2-v3.ckpt")
    check_point_paths.append("~/work/code/udacity-gym/new_data/dave2-v4.ckpt")
    check_point_paths.append("~/work/code/udacity-gym/new_data/dave2-v5.ckpt")
    check_point_paths.append("~/work/code/udacity-gym/new_data/dave2-v6.ckpt")
    ...
    for path in check_point_paths:
        ...
        models.append(
           Dave2.load_from_checkpoint(checkpoint_path)
        )
    ...
    for i in range(0, len(variance_value), chunk_size):
        ...
        plt.ylim(0, max_y)
        plt.title("Ensemble - day")
        plt.savefig("plot/ensemble/new_data/day/plot_" +str(i)+".png")
        plt.clf()
    ...
    for i in range(0, len(variance_value), chunk_size):
        ...
        plt.axhline(y=T, color='r', linestyle='-')
        plt.ylim(0, max_y)
        plt.title("Ensemble - daynight")
        plt.savefig("plot/ensemble/new_data/night/plot_" +str(i)+".png")
        plt.clf()
    ...
    for i in range(0, len(segmentation), 2):
        ...
        if j%2==0:
            ...
            ttl="day"
        plt.title("Ensemble - "+ ttl)
        plt.savefig("plot/ensemble/new_data/night_v2/plot_" +str(j)+".png")
        plt.clf()
        j= j+1
        '''
    ...
    df.to_csv('metrics/new_data/mw_deepensemble.csv', index=False)
